...
namespace Metaversando.WorkSpace
{
    public class LogInManager : MonoBehaviourPunCallbacks
    {
        ...
        const string AVATAR_PREFAB_NAME = "CustomAvatarEntity";

        [SerializeField] TMP_Text m_screenText;
        [SerializeField] Camera m_camera;
        [SerializeField] float SPAWN_POS_Y = -1f;
        ...
        void InstantiateNetworkedAvatar()
        {
            ...
            Vector3 spawnPos = new Vector3(rand_x, SPAWN_POS_Y, rand_z);
