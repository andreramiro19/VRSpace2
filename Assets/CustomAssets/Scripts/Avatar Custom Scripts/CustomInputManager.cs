 ...
 */
public class CustomInputManager : OvrAvatarInputManager
{
    private const string logScope = "CustomInput";
...
#pragma warning restore CS0414 // is assigned but its value is never used
    ...
    {
        _useOvrCameraRig = this.transform.parent.GetComponent<OVRCameraRig>();
