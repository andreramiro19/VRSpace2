...
public class FPS_Controller : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        m_Rigid.MoveRotation(Quaternion.Euler(Vector3.zero));

        m_CapsuleCollider = GetComponent<CapsuleCollider>();
        m_CapsuleCollider.height = GameManager.Instance.playerData.playerHeight + 0.10f;

        GameManager.Instance.ChangeSpecs += SetAvatarSpeed;
        GameManager.Instance.ChangeSpecs += SetAvatarLookSensitivity;
    ...
    private void SetAvatarSpeed()
    {
        speed = GameManager.Instance.playerSpeed;
    }

    private void SetAvatarLookSensitivity()
    {
        m_lookSensitivity = GameManager.Instance.lookSensitivity;
    }
